...
# import_ms(msfilename, export_uvtable=True, filename=msfilename+".uvtab")

# load the visibility
print("Loading visibility data...")
#datafilepath = "/raid/work/yamato/edisk_data/analysis_data/"
uvtabfilename = datafilepath + "L1489IRS_SB1_continuum.bin_30s.ms.uvtab"
...
with open(datafilepath + "L1489IRS_SB1_continuum_sampler_{:s}.pkl".format(model_name), "wb") as f:
...
np.save("./L1489IRS_SB1_continuum_PointSource_GaussianRing_Gaussian_MAP_vis.npy", MAP_vis)
...
figpath = "./fig_{:s}_SB1_{:s}/".format(source, model_name)
