...
model_name = "SBLB_DDT_PointSource_GaussianRing_Gaussian"
...
datafilepath = "/raid/work/yamato/edisk_data/analysis_data/DDT_LP/"
...
# with open(datafilepath + "L1489IRS_continuum_sampler_{:s}.pkl".format(model_name), "wb") as f:
...
with open(
    datafilepath + "L1489IRS_continuum_sampler_{:s}.pkl".format(model_name), "rb"
) as f:
...
np.save("./L1489IRS_continuum_MAP_vis_{:s}.npy".format(model_name), MAP_vis)
